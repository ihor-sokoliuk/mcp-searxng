...
export const READ_URL_TOOL: Tool = {
  ...
  description:
    ...
    "When the operator configures FlareSolverr, mcp-searxng attempts to acquire a browser session after URL validation and a HEAD size preflight for each uncached URL read; cache hits bypass acquisition and busy or unavailable attempts use an uncached direct-fetch fallback. " +
    "Three modes: " +
