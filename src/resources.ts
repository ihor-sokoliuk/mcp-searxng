...
- \`result_detail\` (optional): \`full\` (default) preserves SearXNG metadata, warnings, and research signals; \`compact\` returns only title, description, and URL fields per result. Use full when answers, infoboxes, corrections, suggestions, or provenance matter.
