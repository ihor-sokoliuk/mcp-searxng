...
/**
 * E2E Tests: searxng_instance_info tool against live SearXNG instance.
 *
...
async function runTests() {
  console.log('🌐 E2E Testing: searxng_instance_info (live)\n');
  ...
  printTestSummary(results, 'E2E: Instance Info');
  return results;
}
