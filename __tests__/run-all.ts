...
import { runTests as runBrowserSolverContentTests } from './unit/browser-solver-content.test.js';
...
const testSuites: TestSuite[] = [
  ...
  { name: 'Browser Solver Content', category: 'unit', run: runBrowserSolverContentTests },
